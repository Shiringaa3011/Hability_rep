...
// in habitly/test/features/groups/data/repositories/group_repository_impl_test.dart.
...
class MockGroupLocalDataSource extends _i1.Mock
    implements _i10.GroupLocalDataSource {
  MockGroupLocalDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i11.GroupEntity>? getCachedGroups(String? userId) =>
      (super.noSuchMethod(Invocation.method(
        #getCachedGroups,
        [userId],
      )) as List<_i11.GroupEntity>?);

  @override
  _i8.Future<void> cacheGroups(
    String? userId,
    List<_i11.GroupEntity>? groups,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #cacheGroups,
  ...
  @override
  _i8.Future<void> invalidateGroups(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #invalidateGroups,
          [userId],
        ),
